...
namespace esphome
{
  namespace igrill
  {
    ...
    public:
      ...
      void set_send_value_when_unplugged(bool send_value_when_unplugged) { ESP_LOGCONFIG(TAG, "send_value_when_unplugged: %d", send_value_when_unplugged); send_value_when_unplugged_ = send_value_when_unplugged; }
